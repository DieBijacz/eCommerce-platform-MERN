...
const Hero = () => {
  ...
  return (
    <Row className='hero-high'>
      <div className='hero'>
          <div className='test'>
            <div className='animated' style={{fontSize: '12vw', letterSpacing: '3vw', fontWeight: 'bold'}}>DEEPER</div>
            <div className='animated' style={{fontSize: '8vw', letterSpacing: '1vw'}}>CONCENTRATION</div>
          </div>
